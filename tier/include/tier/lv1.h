...
#	if !defined(LV1_CALL)
#		define LV1_CALL(_name, _in, _out, _num) \
			extern s64 JOIN(_lv1_, _name)(LV1_##_in##_IN_##_out##_OUT_ARG_DECL); \
			static inline s64 JOIN(lv1_, _name)(LV1_##_in##_IN_##_out##_OUT_ARG_DECL) { \
				return JOIN(_lv1_, _name)(LV1_##_in##_IN_##_out##_OUT_ARGS); \
			}
#	endif
