...
#ifndef _PAYLOAD_SPU_H_
#define _PAYLOAD_SPU_H_
...
u8 spu_mfc_cmd_exec(struct spu_problem volatile *spu_problem, u32 lsa, u64 ea, u16 size, u16 tag, u16 classid, u16 cmd);
u8 spu_mfc_cmd_tag_status(struct spu_problem volatile *spu_problem, u8 tag);

#endif /* !_PAYLOAD_SPU_H_ */
